...
const HomePage = () => {
  return (
    <div className="flex justify-center">
      ...
      <div className="relative flex flex-col md:flex-row items-start max-w-screen-lg">
        {/* PICTURE */}
        ...
        <div className="bg-white text-start p-10 mb-10 flex flex-col gap-5 relative flex-1">
          ...
          <h2 className="text-center  chef-name text-xl z-20 md:pt-60">
          ...
          <p>
            ...
            établissements de renom, comme le restaurant étoilé Qui Plume La
            Lune et le prestigieux George V Paris. 💫
          </p>
          <p>
          ...
          <p>
            ...
            prêt à partager avec vous tout son savoir-faire et sa passion pour
            la gastronomie.
          </p>
          <p>
